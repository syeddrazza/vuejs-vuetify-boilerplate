    ...
    <v-stepper-header>
      ...
      >
        <div class="d-flex flex-column text-center text-no-wrap">
          ...
          <span class="text--primary text-sm font-weight-semibold">About You</span>
      ...
      >
        <div class="d-flex flex-column text-center text-no-wrap">
          ...
          <span class="text--primary text-sm font-weight-semibold">Select a Card</span>
          <span class="text--secondary text-xs">Any card of your choice</span>
        </div>
      </v-stepper-step>
      ...
      >
        <div class="d-flex flex-column text-center text-no-wrap">
          ...
          <span class="text--primary text-sm font-weight-semibold">More Information</span>
          <span class="text--secondary text-xs">Your personal details</span>
        </div>
      </v-stepper-step>
      ...
      >
        <div class="d-flex flex-column text-center text-no-wrap">
          ...
          <span class="text--primary text-sm font-weight-semibold">Review Details</span>
          <span class="text--secondary text-xs">Your personal details</span>
        </div>
      </v-stepper-step>
      <v-divider></v-divider>
      ...
      <v-stepper-step step="5">
        <div class="d-flex flex-column text-center text-no-wrap">
          ...
          <span class="text--primary text-sm font-weight-semibold">E-Sign And Upload</span>
          <span class="text--secondary text-xs">Sign and upload your application</span>
        </div>
      </v-stepper-step>
    </v-stepper-header>
